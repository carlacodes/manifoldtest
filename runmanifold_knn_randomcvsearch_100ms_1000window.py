...
def main():
    ...
    labels = np.load(f'{dlc_dir}/labels_1203_with_dist2goal_scale_data_False_zscore_data_False_overlap_False_window_size_100.npy')
    spike_data = np.load(f'{spike_dir}/inputs_overlap_False_window_size_100.npy')
    ...
    filename = f'params_all_trials_100binwidth_randomizedsearchcv_1000windows_jake_fold_sinandcos_{now}.npy'
    filename_mean_score = f'mean_score_100binwidth_randomizedsearchcv_1000windows_jake_fold_sinandcos_{now_day}.npy'
