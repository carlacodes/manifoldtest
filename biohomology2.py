...
def calculate_bottleneck_distance(all_diagrams, folder_str, num_threads=20):
    """
...
if __name__ == '__main__':
    ...
    if not individual_dicts:
        #save the big_list to a pkl file
        #run the bottleneck distance calculation
        distance_matrix_dict = calculate_bottleneck_distance(big_list, base_dir)
        with open(f'{base_dir}/all_diagrams.pkl', 'wb') as f:
