...
def main():
    ...
    filename = f'params_all_trials_500binwidth_randomizedsearchcv_1000windows_jake_fold_sinandcos_{now}.npy'
    filename_mean_score = f'mean_score_500sbinwidth_randomizedsearchcv_1000windows_jake_fold_sinandcos_{now_day}.npy'
