...
def main():
    ...
    filename = f'params_all_trials_randomizedsearchcv_binwidth50_200windows_jake_fold_sinandcos_{now}.npy'
    filename_score = f'mean_score_all_trials_randomizedsearchcv_binwidth50_200windows_jake_fold_sinandcos_{now}.npy'
