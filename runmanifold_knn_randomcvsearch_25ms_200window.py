...
def main():
    ...
    labels = np.load(f'{dlc_dir}/labels_1203_with_dist2goal_scale_data_False_zscore_data_False_overlap_False_window_size_25.npy')
    spike_data = np.load(f'{spike_dir}/inputs_overlap_False_window_size_25.npy')
    ...
    filename = f'params_all_trials_randomizedsearchcv_binwidth25_200windows_jake_fold_sinandcos_{now}.npy'
    filename_score = f'mean_score_all_trials_randomizedsearchcv_binwidth25_200windows_jake_fold_sinandcos_{now}.npy'
