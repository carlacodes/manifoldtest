...
import logging
import sys
sys.path.append('/nfs/nhome/live/carlag/granger_lfp_and_manifold/')

from manifoldtest.all_var_decoding.helpers import tools
import os
import scipy
...
def main():
    ...
    save_dir_path = Path(f'{data_dir}/randsearch_sincostogoal_lfadssmooth_1000windows_1000iter_independentvar_{now_day}')
