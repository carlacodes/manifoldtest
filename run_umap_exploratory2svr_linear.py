...
def unsupervised_umap(spks, bhv, remove_low_variance_neurons = True, neuron_type = 'unknown', filter_neurons = False, n_components = 3):
    ...
    if n_components == 2:
        ...
        for var in list_of_vars:
            ...
            plt.title(f'UMAP projection of the dataset, color-coded by: {var}', fontsize=15)
            if filter_neurons:
                plt.savefig(f'/ceph/scratch/carlag/honeycomb_neural_data/rat_7/6-12-2019/figures/latent_projections/umap_angle_3d_colored_by_{var}_neuron_type_{neuron_type}.png', bbox_inches='tight', dpi=300)
            else:
                plt.savefig(f'/ceph/scratch/carlag/honeycomb_neural_data/rat_7/6-12-2019/figures/latent_projections/umap_angle_3d_colored_by_{var}_all_neurons_num_components_{n_components}.png', bbox_inches='tight', dpi=300)
            plt.show()
...
def main():
    ...
    filename = f'results_{now}_linear.npy'
    results_between = {}
    results_within = {}
    n_permutations = 20
