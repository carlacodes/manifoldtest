...
def train_and_test_on_reduced(
    ...
    param_grid = {
        ...
        'reducer__n_neighbors': [15, 30, 70],
        'reducer__min_dist': [0.001, 0.01, 0.1, 0.2, 0.3],
...
def main():
    ...
    for params in ParameterSampler(param_grid_upper, n_iter=n_iter):
        ...
        filename = f'params_sinandcos_poly_{now}.npy'
        filename_intermediate_params = f'intermediate_params_sin_and_cos_v2_poly_{now_day}.npy'
