...
def main():
    ...
    previous_results, score_dict = DataHandler.load_previous_results('randsearch_allvars_lfadssmooth_340windows_1000iter_independentvar_', window_size=340, bin_size = 250)
