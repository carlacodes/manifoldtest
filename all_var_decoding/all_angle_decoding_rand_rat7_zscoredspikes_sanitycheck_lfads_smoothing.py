...
def main():
    ...
    X_for_umap = apply_lfads_smoothing(spike_data_copy)
    #then standardising
    ...
    save_dir_path = Path(f'{data_dir}/randsearch_allvars_1000windows_10foldcv_zscoredspikes_sanitycheck_lfadssmoothing_{now_day}')
