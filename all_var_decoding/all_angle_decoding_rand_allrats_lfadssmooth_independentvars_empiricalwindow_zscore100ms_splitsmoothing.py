...
def main():
    ...
    for data_dir in  [f'{base_dir}/rat_7/6-12-2019', f'{base_dir}/rat_10/23-11-2021',
        ...
        labels = np.load(
            f'{dlc_dir}/labels_100_scale_to_angle_range_{scale_to_angle_range}.npy')
        col_list = np.load(f'{dlc_dir}/col_names_100_scale_to_angle_range_{scale_to_angle_range}.npy')
        ...
        window_df = window_df[window_df['window_size'] == window_size]
        ...
        save_dir_path = Path(f'{data_dir}/randsearch_independentvar_lfadssmooth_empiricalwindow_scaled_labels_{scale_to_angle_range}_binsize_{window_size}_splitsmoothing_{now_day}')
        ...
        best_params, mean_score = train_and_test_on_umap_randcv(
            ...
            regressor_kwargs,
            reducer,
            reducer_kwargs, logger, save_dir_path, use_rand_search=True, manual_params=None, savedir=save_dir_path, rat_id=rat_id, num_windows = num_windows
        )
