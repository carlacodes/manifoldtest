...
def evaluate_params(spks, y, custom_folds, regressor, regressor_kwargs, reducer, reducer_kwargs, params):
    ...
    for train_index, test_index in custom_folds:
        ...
        #apply lfads smoothing
        X_train, indices_to_remove_train = tools.apply_lfads_smoothing(X_train)
        X_test, indices_to_remove_test = tools.apply_lfads_smoothing(X_test)
        #remove the indices from y_test and y_train
...
def main():
    ...
    for data_dir in [f'{base_dir}/rat_7/6-12-2019', f'{base_dir}/rat_10/23-11-2021',
        ...
        save_dir_path = Path(f'{data_dir}/randsearch_sanitycheck_allvars_parallel_lfadssmooth_{now_day}')
