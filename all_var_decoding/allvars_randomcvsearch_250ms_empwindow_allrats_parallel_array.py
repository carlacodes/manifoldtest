...
def main():
    ...
    filename = f'params_all_trials_randomizedsearchcv_250bin_1000windows_jake_fold_{now}.npy'
    filename_mean_score = f'mean_score_all_trials_randomizedsearchcv_250bin_1000windows_jake_fold_{now_day}.npy'
    save_dir_path = Path(f'{data_dir}/randsearch_sanitycheck_allvars_parallel_array_{now_day}')
