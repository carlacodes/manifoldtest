...
def main():
    ...
    X_for_umap = scipy.ndimage.gaussian_filter(spike_data_copy, 2, axes=0)
    #then standardising
    ...
    save_dir_path = Path(f'{data_dir}/randsearch_allvars_1000windows_10foldcv_zscoredspikes_sanitycheck_smoothed_beforezscore_{now_day}')
