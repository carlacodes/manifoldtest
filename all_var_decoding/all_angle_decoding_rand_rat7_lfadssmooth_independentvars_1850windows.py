...
def train_and_test_on_umap_randcv(
    ...
    custom_folds = create_folds(n_timesteps, num_folds=5, num_windows=1850)
...
def main():
    ...
    filename_mean_score = f'mean_score_all_trials_randsearch_250bin_1850windows_jake_fold_{now}.npy'
    save_dir_path = Path(f'{data_dir}/randsearch_allvars_lfadssmooth_1850windows_1000iter_independentvar_{now_day}')
