...
def train_and_test_on_umap_randcv(
    ...
    if use_rand_search:
        ...
        print('initialising randomizedsearchcv')
...
def main():
    ...
    data_dir = f'{base_dir}/rat_7/6-12-2019' # Get data_dir from command line argument
    ...
    save_dir_path = Path(f'{data_dir}/test_folder/umap_randsearch_sanitycheckallvarindepen_sklearnpipeline_{now_day}')
