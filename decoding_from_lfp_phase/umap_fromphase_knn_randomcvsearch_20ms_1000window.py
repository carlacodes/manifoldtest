...
def train_and_test_on_umap_randcv(
    ...
    for _ in range(50):  # 100 iterations for RandomizedSearchCV
        ...
        for train_index, test_index in custom_folds:
            ...
            scores.append(score)
            print('current score for this fold :', score)
...
def main():
    data_dir = '/ceph/scratch/carlag/honeycomb_neural_data/rat_9/10-12-2021/'
    ...
    save_dir_path = data_dir_path / 'lfp_phase_manifold'
